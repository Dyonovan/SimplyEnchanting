...
public class Reference {
    ...
    public static final String DEPENDENCIES = "required-after:forge@[14.21.0.2347,);after:JEI@[4.6.0.61,);";//required-after:bookshelfapi@[5.0.0,);"; //required-after:mcmultipart@[1.0.7,)
